...
wtoGuess = np.arange(1000,6500,1)
#Gudmundsson
...
Vc = read_from_db("maxSpeed")/1.2   #AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
cbhp = 0.4
fuelAllowance = 5 # in %
...
U=0.04 
CLC=.28 # MATLAB??? AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
CLFLAP=0.8 
CLTO=CLC+CLFLAP 
...
cruiseSpeed = read_from_db("maxSpeed")/1.2

print(cruiseSpeed,"cruiseSpeed")
...
clc=(2*Wave)/(altitudeDensity*S1*(cruiseSpeed*1.688)**2) 
print("altitudeDensity",altitudeDensity)
print("Wave",Wave)
print ("S1",S1)
print("clc",clc)
write_to_db('clc',clc/1.688)
clcw=clc/0.95 
cli=clcw/0.9
write_to_db('cli',cli)
...
wtaper=1#AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
